...
void sort_pairs(void)
{
    ...
    {
        int strength_one = preferences[pairs[i].loser][pairs[i].winner] - preferences[pairs[i].winner][pairs[i].loser];
        int winner = pairs[i].winner;
        int loser = pairs[i].loser;

        for (int j = i + 1; j < pair_count - 1; ++j)
        {
            int strength_two = preferences[pairs[j].loser][pairs[j].winner] - preferences[pairs[j].winner][pairs[j].loser];
